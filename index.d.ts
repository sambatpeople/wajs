...
declare namespace WAJS {
    ...
    export class Client extends EventEmitter {
        ...
        playBrowser?: playwright.Browser
        ...
        /** Emitted when the pairing code is received */
    ...
    export interface ClientOptions {
        ...
        * Number of last chats to check live location after a page reload */
        ...
        playwright?: playwright.ConnectOptions & playwright.BrowserContextOptions & playwright.LaunchOptions
        /** The version of WhatsApp Web to use. Use options.version to configure how the version is retrieved. */
        version?: string,
        /** How many times should the qrcode be refreshed before giving up
         * @default 0 (disabled) */
        qrMaxRetries?: number,
        /** Set up your pairing number */
        pairingNumber?: string,
        /** Set your browser and WhatsApp session name, default session
         * @default .wajs_auth */
        sessionName?: string,
